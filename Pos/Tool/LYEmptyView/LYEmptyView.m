...
- (void)setupSubviews{
    ...
    contentMaxWidth = self.emptyViewIsCompleteCoverSuperView ? 170 : self.ly_width - 30.f;
...
- (void)setSelfviewY:(CGFloat)selfviewY
{
    _selfviewY = selfviewY;
     self.ly_y = self.selfviewY;
}
