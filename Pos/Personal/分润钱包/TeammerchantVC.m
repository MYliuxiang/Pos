...
@interface TeammerchantVC ()<UITableViewDelegate,UITableViewDataSource>

@end

@implementation TeammerchantVC
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section ==0) {
     ...
     TeammerchatCell *cell=[tableView dequeueReusableCellWithIdentifier:@"TeammerchatCell"];
    if (cell==nil) {
        cell=[[TeammerchatCell alloc] init];
        [cell setRestorationIdentifier:@"UITableViewCell"];
    }
    cell.selectionStyle = UITableViewCellSelectionStyleNone;
    //线条
