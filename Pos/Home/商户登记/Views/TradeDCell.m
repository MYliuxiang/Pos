...
- (void)setExpanded:(BOOL)expanded{
    _expanded = expanded;
    if (_expanded) {
        self.arrowI.transform = CGAffineTransformMakeRotation(M_PI);
    } else {
        self.arrowI.transform = CGAffineTransformMakeRotation(0);
    }
}
