...
@property (weak, nonatomic) IBOutlet UILabel *startTime3L;
@property (weak, nonatomic) IBOutlet UILabel *endTime3L;
...
@implementation UnincorporateVC
...
- (void)setUI{
    ...
    self.startTime3L.text = timeStr;
    self.endTime1L.text = timeStr;
    self.endTime2L.text = timeStr;
    self.endTime3L.text = timeStr;
...
- (IBAction)doneAC:(id)sender {
    ...
    entity.urlString = [NSString stringWithFormat:@"%@%@to_legal",MainUrl,Url_merc];
    entity.needCache = NO;
