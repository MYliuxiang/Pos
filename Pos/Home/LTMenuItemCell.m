...
- (UILabel *)titleLabel
{
    if (!_titleLabel) {
        ...
        CGFloat width = kScreen_Width - x - self.selectBtn.left;
...
- (void)setMenuItem:(LTMenuItem *)menuItem
{
    ...
    self.selectBtn.left = x;
    self.titleLabel.left = self.selectBtn.right + 10;
    self.titleLabel.width = _iconImageView.left - 10 - self.titleLabel.left;
    self.lineView.left = x - 1;
    self.lineView.width = kScreen_Width - self.lineView.left - 12;
}
